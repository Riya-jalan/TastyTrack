...
?>
                                ...
                                <div class="form-group row no-gutter">
                                    <div class="col-xs-8">
                                        <input type="text" class="form-control b-r-0" value="<?php echo '₹'.($item['price'] * 75); ?>" readonly id="exampleSelect1">
...
?>
                        ...
                        <div class="widget-body">
                            <div class="price-wrap text-xs-center">
                                <p>TOTAL</p>
                                <h3 class="value"><strong>₹<?php echo ($item_total * 75); ?></strong></h3>
                                <p>Free Delivery!</p>
                                <?php
                                        if($item_total==0){
                                        ?>
                            ...
                            <div class="food-item">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-lg-3 pull-right item-cart-info">
                                        <span class="price pull-left">₹<?php echo ($product['price'] * 75); ?></span>
                                        <input class="b-r-0" type="text" name="quantity" style="margin-left:30px;" value="1" size="2" />
                                        <input type="submit" class="btn theme-btn" style="
