...
<body class="home">
    ...
    <section class="hero" style="background: url('images/back.jpg') no-repeat center center fixed; background-size: cover; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; position: relative; min-height: 100vh; display: flex; align-items: center; justify-content: center; color: white; text-align: center;">
        <div style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; background: rgba(0, 0, 0, 0.5); z-index: 1;"></div>
        <div class="hero-inner" style="position: relative; z-index: 2; width: 100%; padding: 40px 20px;">
            <div class="container text-center hero-text font-white">
                <h1>Crave it, Track it, Taste it</h1>
    ...
    <section class="popular" style="background: linear-gradient(135deg, #f5f7fa 0%, #e4e8f0 100%); padding: 60px 0;">
        <div class="container">
            <div class="title text-xs-center m-b-30">
                <h2 style="color: #2c3e50; font-weight: 700; text-shadow: 1px 1px 2px rgba(0,0,0,0.1);">Customer Favorite Dishes of the Month</h2>
                <p class="lead" style="color: #7f8c8d;">Savor the best of Indian cuisine with these top 6 dishes</p>
            </div>
            <div class="row">
                <!--  Author Name: MH RONY.
                        GigHub Link: https://github.com/dev-mhrony
                                    ...
                                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="price-btn-block"> <span class="price" style="color: #e74c3c; font-weight: 600;">₹'.($r['price'] * 75).'</span> <a href="dishes.php?res_id='.$r['rs_id'].'" class="btn theme-btn-dash pull-right" style="background: linear-gradient(45deg, #ff6b6b, #ff8e8e); border: none; box-shadow: 0 4px 10px rgba(231, 76, 60, 0.3);">Order Now</a> </div>
                                                </div>
